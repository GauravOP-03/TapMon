  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    axios
      ...
      .catch((e) => {
        console.error(e);
        toast({
            title: "Signp Successful",
            description: `Login to Continue, ${formData.email}!`,
            variant: "default",
          });;
      });
  };
    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 relative overflow-hidden">
      ...
      <Card className="w-96 shadow-2xl bg-white bg-opacity-90 backdrop-blur-sm p-6 z-10 border-0 rounded-2xl">
        ...
        <CardHeader className="text-center text-xl font-semibold pt-12">
          <h2 className="text-2xl font-bold bg-gradient-to-r from-primary to-purple-700 bg-clip-text text-transparent">Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="group">
              ...
              <div className="relative mt-1">
                ...
                />
                <User className="absolute left-3 top-3 w-4 h-4 text-gray-500 group-focus-within:text-primary" />
              </div>
            </div>
